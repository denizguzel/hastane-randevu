...
(
  ...
  MESSAGE_TO_DOCTOR    VARCHAR2(255 BYTE),
  EXPIRATION_TIME_FOR_SUSPEND  TIMESTAMP(0)
)
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
...
(
  ...
  SECRET_QUESTION            VARCHAR2(100 BYTE),
  FORGOTTEN_EXPIRATION_DATE  TIMESTAMP(0)
)
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
...
(
  PK                  INTEGER                   NOT NULL,
  SURVEY_QUESTION     VARCHAR2(255 BYTE),
  CREATION_TIME       TIMESTAMP(0)              DEFAULT CURRENT_TIMESTAMP,
  MODIFIED_TIME       TIMESTAMP(0)              DEFAULT CURRENT_TIMESTAMP,
  IS_ACTIVE           CHAR(1 BYTE)              DEFAULT 1,
...
ALTER TABLE HOSPITAL.T_ASKED_QUESTIONS MODIFY 
  PK NULL;
...
ALTER TABLE HOSPITAL.T_HOSPITAL_POLICLINIC_REL MODIFY 
  PK NULL;
...
ALTER TABLE HOSPITAL.T_PATIENT_ALERGY_REL MODIFY 
  PK NULL;
...
ALTER TABLE HOSPITAL.T_PATIENT_ASSAY_REL MODIFY 
  PK NULL;
...
ALTER TABLE HOSPITAL.T_PATIENT_DISEASE_REL MODIFY 
  PK NULL;
...
ALTER TABLE HOSPITAL.T_PATIENT_TREATMENT_REL MODIFY 
  PK NULL;
...
ALTER TABLE HOSPITAL.T_REVIEWS_ABOUT_DOCTOR MODIFY 
  PK NULL;
